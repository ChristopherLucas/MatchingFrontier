...
<<mahal_frontier_plain, eval=TRUE, echo=TRUE, fig = TRUE, include = FALSE>>=
# Plot frontier
...
\begin{minipage}{0.45\textwidth}
<<mahal_frontier_pretty, eval=TRUE, echo=TRUE, fig = TRUE, include = FALSE>>=  
# Plot frontier
plotFrontier(L1.frontier,
             cex.lab = 1.4,
             cex.axis = 1.4,
...
\begin{minipage}{0.45\textwidth}
<<mahal_frontier_est, eval=TRUE, echo=TRUE, fig = TRUE, include = FALSE>>=    
# Plot estimates
...
\begin{minipage}{0.45\textwidth}
<<mahal_parplot, eval=TRUE, echo=TRUE, fig = TRUE, include = FALSE>>=      
# Make parallel plot
