...
replace countryname = "Central African Republic" if countryname == "Central Afr. R."
replace countryname = "Central African Republic" if countryname == "C.A.R."
...
replace countryname = "Congo" if countryname == "Congo (Braz)"
...
replace countryname = "Congo, Democratic Republic of (Zaire)" if countryname == "Zaire/Congo"
replace countryname = "Congo, Democratic Republic of (Zaire)" if countryname == "Congo, Democratic Republic Of "
...
replace countryname = "Myanmar (Burma)" if countryname == "Myanmar/Burma"
...
replace countryname = "Papua New Guinea" if countryname == "Papua New Guin."
replace countryname = "Papua New Guinea" if countryname == "Papua Ng"
