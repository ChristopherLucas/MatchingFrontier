.onAttach <- function(lib, pkg){
    ...
    cite.msg <- "King, Gary, Christopher Lucas, and Richard Nielsen. \"Optimizing Balance and Sample Size in Matching Methods for Causal Inference.\" Working paper (2014)."
